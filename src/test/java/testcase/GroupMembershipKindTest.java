...
public class GroupMembershipKindTest extends BaseLogin {
    ...
    void groupMembershipKindCreation() throws IOException, InterruptedException {
        ...
        Commons.enter(driver, By.xpath(locators.getProperty("group_membership_kind_input_field")), groupMembershipKind);
        Commons.click(driver, By.xpath(locators.getProperty("group_membership_kind_save")));
    ...
    void groupMembershipKindUpdation() throws IOException, InterruptedException {
        ...
        Assert.assertTrue(entryFound, "Expected entry with text '" + groupMembershipKind + "' not found");
        Commons.clearAndEnter(driver, By.xpath(locators.getProperty("group_membership_kind_input_field")), groupMembershipKindUpdated);
